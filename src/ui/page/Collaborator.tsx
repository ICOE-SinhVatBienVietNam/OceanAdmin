...
const Collaborator: React.FC = () => {
    const [collaborators, setCollaborators] = useState<Collaborator[]>(collaboratorsData);
                ...
                <div className="flex gap-4 items-center">
                    {!isEditMode ? (
                        <>
                            ...
                            <button onClick={() => setIsInviteModalOpen(true)} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300">
                                + Mời Quản trị viên
                            </button>
                        </>
                    ) : (
